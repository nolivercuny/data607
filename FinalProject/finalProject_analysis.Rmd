...
sciencePlot <- wrongWords %>% group_by(year) %>% summarise(mean = mean(wrongWords)) %>% ggplot(aes(x=year, y=mean)) + geom_point() + 
...
bPlot <- wrongWords %>% group_by(year) %>% summarise(mean = mean(wrongWords)) %>% ggplot(aes(x=year, y=mean)) + geom_point() + 
...
culturePlot <- wrongWords %>% group_by(year) %>% summarise(mean = mean(wrongWords)) %>% ggplot(aes(x=year, y=mean)) + geom_point() + 
