...
for (link in sample(links,3)) {
  tryCatch(expr={
    ...
    add_row(publishDate = data[1], author = data[2], subject = data[3], byLine = data[4], category = data[5], body = data[6], sourceUrl = link, retrievedAt =format(Sys.time(), "%Y-%m-%d %H:%M:%S %Z"))
  },error=function(e){
