...
```{r}
unicefUrl <- 'https://raw.githubusercontent.com/nolivercuny/data607/master/project2/datasets/childmortality/all_countries_deaths_u5_5_9_10_14_15_24.csv'
...
```{r}
unicef %>% pivot_wider(id_cols = c("Country","Year"))
```
